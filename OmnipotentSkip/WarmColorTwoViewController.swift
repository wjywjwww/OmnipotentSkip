//
//  WarmColorTwoViewController.swift
//  OmnipotentSkip
//
...
class WarmColorTwoViewController: UIViewController {

    @IBOutlet weak var twoLabel: UILabel!
    @IBOutlet weak var oneLabel: UILabel!
    var pushModel : PushModel?
    var dataModel : WarmTwoDataModel = WarmTwoDataModel()
    override func viewDidLoad() {
        super.viewDidLoad()
        if pushModel != nil{
            dataModel = pushModel!.warmTwoModel
        }
