//
//  DeadColorTwoViewController.swift
//  OmnipotentSkip
//
...
class DeadColorTwoViewController: UIViewController {

    @IBOutlet weak var twoLabel: UILabel!
    @IBOutlet weak var oneLabel: UILabel!
    var pushModel : PushModel?
    var dataModel : DeadTwoDataModel = DeadTwoDataModel()
    override func viewDidLoad() {
        super.viewDidLoad()
        if pushModel != nil{
            dataModel = pushModel!.deadTwoModel
        }
